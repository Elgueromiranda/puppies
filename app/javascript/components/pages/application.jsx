    ...
    <div class="flex-grow border-t border-gray-400"></div>
      ...
      <form action="#" className="space-y-8" ref={form} onSubmit={sendEmail}>
          ...
          <div className="sm:col-span-2">
              <label htmlFor="questionOne" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 font-serif Times New Roman">
           ...
           <div className="sm:col-span-2">
              <label htmlFor="questionTwo" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 font-serif Times New Roman">
           ...
           <div className="sm:col-span-2">
              <label htmlFor="questionThree" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 font-serif Times New Roman">
           ...
           <div className="sm:col-span-2">
              <label htmlFor="questionFour" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 font-serif Times New Roman">
